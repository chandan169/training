    ...
    public class IdentityController : ControllerBase
    {
        ...
        public async Task<ActionResult<dynamic>> Register(User user)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                await db.SaveChangesAsync();//save user 
                await SendVerificationMailAsync(user);//send verification mail
                return Created("", new
                {
                    user.Id,
                    user.Fullname,
        ...
        private async Task SendVerificationMailAsync(User user)
        {
            ...
            await helper.SendMessageAsync(messageText, "verification");
        }
    }
}