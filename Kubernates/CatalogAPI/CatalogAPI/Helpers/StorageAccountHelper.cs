...
namespace CatalogAPI.Helpers
{
    ...
    {
        private string storageConnectionString;//connection string for storgae account
        private string tableConnectionString;//cs for cosmmos db
        ...
        public string TableConnectionString//cosmos 
        {
